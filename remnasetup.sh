...
print_header() {
    ...
    echo -e "${MAGENTA}────────────────────────────────────────────────────────────${RESET}"
    if [ "$LANGUAGE" = "en" ]; then
        echo -e "${GREEN}RemnaSetup — proqopev fork${RESET}"
        echo -e "${CYAN}Project: https://github.com/proqopev/RemnaSetup${RESET}"
        echo -e "${YELLOW}Contacts: https://github.com/proqopev${RESET}"
        echo -e "${CYAN}Version: 2.5${RESET}"
        echo
        echo -e "${MAGENTA}────────────────────────────────────────────────────────────${RESET}"
        echo -e "${YELLOW}Fork of: https://github.com/Capybara-z/RemnaSetup${RESET}"
        ...
        echo -e "${GREEN}RemnaSetup — форк proqopev${RESET}"
        echo -e "${CYAN}Проект: https://github.com/proqopev/RemnaSetup${RESET}"
        echo -e "${YELLOW}Контакты: https://github.com/proqopev${RESET}"
        echo -e "${CYAN}Версия: 2.5${RESET}"
        echo
        echo -e "${MAGENTA}────────────────────────────────────────────────────────────${RESET}"
        echo -e "${YELLOW}Форк проекта: https://github.com/Capybara-z/RemnaSetup${RESET}"
